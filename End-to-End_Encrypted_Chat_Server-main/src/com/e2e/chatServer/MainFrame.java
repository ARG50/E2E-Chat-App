...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame(boolean logInitialized, boolean configInitialized, boolean databaseInitialized) {
        ...
        JLabel enterToSearchLabel = new JLabel("<html><center><b>Enter a search string to find matching users</b></center><br>Use the following special characters for advanced searching -<br>% -> for matching any unknown or variable number of characters<br>_ -> for matching only any single character</html>");
    ...
    private void initComponents() {
        ...
        setTitle("E2E Chat Server v" + ConfigManager.getServerVersion());
    ...
    private void restartServerButtonActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        int response = JOptionPane.showConfirmDialog(this, "Are you sure you want to restart the server?", "Restart", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    private void searchTextFieldActionPerformed() {
        ...
        String[][] matchingUsers = DatabaseManager.makeQuery("select * from accounts where " + (usernameRadioButton.isSelected()? "username" : "account_id") + " like ?;", new boolean[]{false}, searchTextField.getText() + "%");
        ...
        for(int i = 0; i < matchingUsers.length; i++)
        {
            ...
            userDetailsButton.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    String[][] userInfo = DatabaseManager.makeQuery("select * from accounts where " + (usernameRadioButton.isSelected()? "username":"account_id") + " = '" + userDetailsButton.getText() + "';", null);
...
//    }
    ...
    private void closeWindow()
    {
        ...
        //Force exit if safe exit doesn't work
        try
        {
            Thread.sleep(5000);
        }
